...
#slider choisir dark mode/light mode
couleurbackground='white'
sliderchangebg=Scale(fenetre,from_=0,to=1,command=getcouleurbg,bd=0,orient=HORIZONTAL,sliderlength=25,showvalue=0,length=50,width=20)
sliderchangebg.pack(anchor=NE,pady=10,padx=10)
sliderchangebg.set(0)
getcouleurbg(0)

fenetre.config(bg=couleurbg())
